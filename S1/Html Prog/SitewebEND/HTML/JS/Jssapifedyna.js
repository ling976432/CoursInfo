...
//START LUCAS CODE
//if the guy already visited the website directly redirecting him on the main page so he dont take he form one more time
function CookieSiteLucas() 
{
  if (isCookieDefined("CookieName")===true) {
    createCookie("x",0);
    window.location.replace("hometest.html");
}
}
...
//   } 
// }
//Put the name of the guy who's entering the website in a cookie 
...
//fonction to print the name of the guy of just enterd the website on the welcome page
function HelloAgain()
{
